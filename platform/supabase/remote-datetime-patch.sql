...
-- 3) kids.date_preferences: per-kid override. Renames the previously-unused
...
BEGIN
  IF EXISTS (
    ...
    WHERE table_schema = 'public' AND table_name = 'kids'
    ...
    ALTER TABLE "public"."kids" RENAME COLUMN "preferences" TO "date_preferences";
  ELSE
    ALTER TABLE "public"."kids" ADD COLUMN IF NOT EXISTS "date_preferences" "jsonb";
  END IF;
END $$;
