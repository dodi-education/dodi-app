...
const BACKGROUND_RULES = [
  ...
  "Do NOT paint any frame, panel, plate, board, disc, card, window, podium, spotlight or",
  "empty placeholder area meant to hold game pieces, and do not reserve a blank space",
  "in the middle: the scenery continues naturally across the whole image, because the",
  "game places its own elements on top wherever it needs them.",
