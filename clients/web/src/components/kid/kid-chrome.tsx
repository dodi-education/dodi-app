...
/**
 * The signed-in kid experience: header with kid switcher + compact dodi,
 * PIN/vault gating, offline warmup, and the bottom navigation. Extracted from
 * the (kid) layout so the layout can render bare children for anonymous
 * visitors on the public game page.
 */
