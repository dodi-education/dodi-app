-- Add action history + get_snapshot capability to Drawing game
-- Enables Dodi to guess what has been drawn via action log and canvas vision
-- reverse: Re-run 20260312110000 to restore previous version
UPDATE public.games
SET
code_bundle = $code$
<!doctype html>
...
metadata = '{
    "version": "1.3.0",
    "capabilities": ["set_color", "set_brush_size", "draw_shape", "draw_line", "draw_curve", "clear_canvas", "undo", "get_snapshot"],
    "category": "drawing",
